...
public class LibraryTest{
		...
		Resource[] checkedOutTayloe = Library.getAllUserHasCheckedOut(library, "Tayloe");

		System.out.println();
		System.out.println("All checked out to Tayloe:");
		for(int i = 0; i < checkedOutTayloe.length; i++){
			System.out.println(checkedOutTayloe[i].getTitle()+" ("+checkedOutTayloe[i].getType()+")");
		}
